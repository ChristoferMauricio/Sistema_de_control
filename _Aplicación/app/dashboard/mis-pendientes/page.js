    ...
    <div className="space-y-6">
      ...
      <div className="animate-fade-in">
        ...
        <p className="text-secondary-text mt-1">
          Tickets asignados a <span className="text-primary-light font-medium">{userEmail}</span>
        </p>
      </div>
      ...
      {tickets.length === 0 && !loading && (
        <div className="glass rounded-2xl p-8 text-center animate-fade-in">
          ...
          <h3 className="text-lg font-semibold text-foreground mb-1">¡Sin pendientes!</h3>
          <p className="text-secondary-text text-sm">No tienes tickets asignados en este momento.</p>
        </div>
      )}
