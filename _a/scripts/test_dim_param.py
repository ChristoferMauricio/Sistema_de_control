...
tests = [
    ("gemini-embedding-2_768", f"https://generativelanguage.googleapis.com/v1/models/gemini-embedding-2:embedContent?key={gemini_key}", {
        "model": "models/gemini-embedding-2",
        "content": {"parts": [{"text": "hola"}]},
        "outputDimensionality": 768
    }),
    ("gemini-embedding-001_768", f"https://generativelanguage.googleapis.com/v1/models/gemini-embedding-001:embedContent?key={gemini_key}", {
