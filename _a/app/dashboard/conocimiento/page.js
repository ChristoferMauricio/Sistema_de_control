                    ...
                    <div className="prose prose-sm max-w-none prose-headings:font-bold prose-p:my-1 text-inherit">
                      {msg.role === "user" ? (
                        ...
                        <ReactMarkdown
                          ...
                          components={{
                            table: ({ node, ...props }) => (
                              <div className="overflow-x-auto my-3.5 rounded-xl border border-gray-200 shadow-sm max-w-full bg-white">
                                <table className="min-w-full divide-y divide-gray-150 text-left text-xs text-gray-700" {...props} />
                              </div>
                            ),
                            thead: ({ node, ...props }) => <thead className="bg-gray-50/75 text-[10px] font-bold text-gray-500 uppercase tracking-wider border-b border-gray-200" {...props} />,
                            ...
                            th: ({ node, ...props }) => <th className="px-4 py-2.5 font-bold text-gray-900 border-b border-gray-200" {...props} />,
                            td: ({ node, ...props }) => <td className="px-4 py-2.5 font-medium text-gray-600 whitespace-nowrap" {...props} />,
                            a: ({ node, ...props }) => <a className="text-orange-600 hover:text-orange-700 underline font-semibold transition-colors" target="_blank" rel="noopener noreferrer" {...props} />,
                            ul: ({ node, ...props }) => <ul className="list-disc pl-5 my-2 space-y-1 text-gray-700" {...props} />,
                            ol: ({ node, ...props }) => <ol className="list-decimal pl-5 my-2 space-y-1 text-gray-700" {...props} />,
                            li: ({ node, ...props }) => <li className="font-medium" {...props} />,
                            h1: ({ node, ...props }) => <h1 className="text-base font-bold text-gray-900 mt-4 mb-2" {...props} />,
                            h2: ({ node, ...props }) => <h2 className="text-sm font-bold text-gray-900 mt-3 mb-1.5" {...props} />,
                            h3: ({ node, ...props }) => <h3 className="text-xs font-bold text-gray-800 mt-2 mb-1" {...props} />,
