...
const STATUS_DEFS = [
  ...
  { key: "qa", label: "QA", match: ["control de calidad", "qa en dev"], color: "bg-amber-100 text-amber-700 dark:bg-amber-900/60 dark:text-amber-300" },
  { key: "finalizada", label: "Finalizada", match: ["finalizada", "listo (pase a cert)", "terminada", "done", "cerrado", "resuelto", "cerrada"], color: "bg-green-100 text-green-700 dark:bg-green-900/60 dark:text-green-300" },
];
